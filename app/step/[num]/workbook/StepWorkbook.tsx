            ...
            <>
                ...
                <main className="page-content" style={{ paddingBottom: '100px' }}>
                    ...
                    <div style={{ marginTop: '20px' }}>
                        <Link href="/step/1/working" className="text-link">
                            Read Working Step 1 →
                        </Link>
                    </div>
                </main>
        ...
        return (
            <>
                ...
                <main className="page-content" style={{ paddingBottom: '100px' }}>
                    ...
                    <div style={{ marginTop: '20px' }}>
                        <Link href={`/step/${stepNum}/working`} className="text-link">
    ...
    if (stepNum === 4 || stepNum === 8 || stepNum === 10 || stepNum === 11) {
        ...
        return (
            <>
                ...
                <FAB onClick={() => {
                    if (stepNum === 4) {
                        router.push('/step/4/workbook/selection');
                    } else if (stepNum === 8) {
                        router.push('/step/8/workbook/selection');
                    } else if (stepNum === 10) {
                        router.push('/step/10/workbook/selection');
                    } else {
        ...
        return (
            <>
                ...
                <main className="page-content">
                    ...
                    <div style={{ textAlign: 'center', marginTop: '20px' }}>
                        <Link href="/step/9/working" className="text-link">
                            Read Working Step 9 →
                        </Link>
                    </div>
                </main>
